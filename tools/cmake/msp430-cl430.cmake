...
find_program(CMAKE_ASM_COMPILER cl430 PATHS "$ENV{MSP430_CCS_INSTALL}/bin" NO_DEFAULT_PATH)
find_program(CMAKE_C_COMPILER cl430 PATHS "$ENV{MSP430_CCS_INSTALL}/bin" NO_DEFAULT_PATH)
find_program(CMAKE_CXX_COMPILER cl430 PATHS "$ENV{MSP430_CCS_INSTALL}/bin" NO_DEFAULT_PATH)
find_program(CMAKE_C_LINK_EXECUTABLE cl430 PATHS "$ENV{MSP430_CCS_INSTALL}/bin" NO_DEFAULT_PATH)

#hex430 converts output file to hex file
find_program(CG_TOOL_HEX hex430 PATHS "$ENV{MSP430_CCS_INSTALL}/bin" NO_DEFAULT_PATH)
